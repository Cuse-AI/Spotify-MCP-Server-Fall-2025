"""Batch 12: Nostalgic variations (5 sub-vibes)"""
import praw, os, pandas as pd, time, re
from datetime import datetime
from dotenv import load_dotenv
load_dotenv('../.env')

class RedditExpansionBatch12:
    def __init__(self):
        ...
        self.search_queries = {
            'Nostalgic - Childhood': ['childhood nostalgia music', 'growing up songs', 'youth memories playlist', 'when I was kid'],
            'Nostalgic - Teen Years': ['teen nostalgia', 'high school memories', 'teenage years music', 'adolescent nostalgia'],
            'Nostalgic - 90s': ['90s nostalgia music', '90s throwback', '90s childhood', 'remember the 90s'],
            'Nostalgic - 2000s': ['2000s nostalgia', 'early 2000s music', '2000s throwback', 'remember 2000s'],
            'Nostalgic - Simpler Times': ['simpler times music', 'easier days', 'before everything changed', 'good old days'],
        }
    ...
    def save_for_ananki(self, data):
        ...
        fn = f'reddit_batch12_nostalgic_variations_{datetime.now().strftime("%Y%m%d_%H%M%S")}.csv'
...
def main():
    print("="*70 + "\nBATCH 12: NOSTALGIC\n" + "="*70)
    scraper = RedditExpansionBatch12()
